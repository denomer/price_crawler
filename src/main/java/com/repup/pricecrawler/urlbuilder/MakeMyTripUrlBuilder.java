...
public class MakeMyTripUrlBuilder {

	private String hotelUrl = "";
	private Logger logger = Logger.getLogger(this.getClass());
	//SAMPLE DATE FORMAT  09302015 
	private int totalAttempt = 0;
	private String additionalParameter = "&ajaxCall=T&i=null";
	
	public MakeMyTripUrlBuilder(String hotelUrl) {
	...
	private void getAjaxPriceUrl(String parameters,String viewerUrl,HotelPriceDetail priceDetail) {
		...
		try
		{
			...
			Connection connection3 = Jsoup.connect(ajaxPriceUrl).ignoreContentType(true)
					.header("Accept-Encoding", "gzip, deflate, sdch")
					.header("Accept-Language", "en-US,en;q=0.8")
					.userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:23.0) Gecko/20100101 Firefox/23.0")
					.referrer(viewerUrl);
			...
			//System.out.println(jsonResponse.body().text());
